                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_tour" id="nama-tour"
                                        class="form-control @error('nama_tour') is-invalid @enderror"
                                        value="{{ $tour->nama_tour }}">
                                    @error('nama_tour')
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <select class="form-control @error('lokasi') is-invalid @enderror" name="lokasi"
                                            ...
                                            <option value="Nusa Penida"
                                                {{ $tour->lokasi == 'Nusa Penida' ? 'selected' : '' }}>Nusa Penida</option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <div class="">
                                            <input type="text" name="id_gambar" id="gambar"
                                                class="btn btn-outline-warning" data-toggle="modal"
                                                data-target="#modalGaleri" placeholder="{{ $tour->id_gambar }}"
                                                value="{{ $tour->id_gambar }}" readonly>
                                            @error('id_gambar')
                                ...
                                <div class="row justify-content-end">
                                    <button type="submit" class="btn btn-primary mb-3 ml-2"><i class="fa fa-save"></i>
