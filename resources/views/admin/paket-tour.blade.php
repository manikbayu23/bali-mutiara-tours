        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('tambah-tour') }}" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah
                                Tour</a>
                                        ...
                                        @if ($tour->total() > 0)
                                            @foreach ($tour as $index => $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <form action="{{ route('archived-tour', $row->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                ...
                                                                @else
                                                                    <button type="submit" class="btn btn-secondary mr-2"><i
                                                            ...
                                                            <a href="" data-nama="{{ $row->nama_tour }}"
                                                                data-id="{{ $row->id }}"
                                                                class="btn btn-danger mr-2 delete"><i class="fa fa-trash"
                                                                    aria-hidden="true"></i>
                                                            </a>
                                                            <a href="{{ route('edit-tour', $row->slug) }}"
