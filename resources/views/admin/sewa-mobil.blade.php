...
@section('judul_halaman', 'Sewa Mobil')
                            ...
                            <form action="{{ route('tambah-mobil') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_mobil" class="form-control" id="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="foto_mobil" class="form-control" id="foto_mobil"
                                            accept="image/*">
                                        @error('foto_mobil')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <tbody>
                            ...
                            @forelse ($mobil as $row)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('images/mobil/' . $row->foto_mobil) }}" width="200px"
                                            class="img-fluid" alt="{{ $row->foto_mobil }}">
                                ...
                                <div class="modal fade" id="edit{{ $row->id }}" data-backdrop="static"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="/admin/update-mobil/{{ $row->slug }}" method="post"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="foto_mobil" class="form-control"
                                                            id="foto_mobil" value="{{ $row->foto_mobil }}"
                                                            accept="image/*">
                                                        @if ($row->foto_mobil)
                                                            <div class="mt-2">
                                                                <p>Foto saat ini:</p>
